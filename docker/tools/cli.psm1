...
function Start-Docker {
    ...
    Push-Location $DockerRoot #Forcefully push the location for local development purpose.
    ...
    Write-Host "`nif something failed along the way, press [ctrl-c] to stop the dance and try again. Use '.\remove' to clean up if needed..`n" -ForegroundColor Gray
    ...
    Write-Host "`nIf the request fails with a 404 on the first attempt then the wait wasn't long enough - just hit refresh..`n`n" -ForegroundColor DarkGray
